...
# Import the Base from database to access metadata
...
from app.models.password_entry import PasswordEntry  # noqa: F401
...
# Commenting out to avoid logging configuration issues
